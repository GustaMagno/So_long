...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/01 20:44:01 by gustoliv          #+#    #+#             */
/*   Updated: 2025/09/01 20:44:01 by gustoliv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	mlx.mlx_win = mlx_new_window(mlx.mlx, mlx.map.len_r * 64, mlx.map.len_c
			* 64, "So_Long");
	mlx.buffer.img = mlx_new_image(mlx.mlx, mlx.map.len_r * 64, mlx.map.len_c
			* 64);
	mlx.buffer.addr = mlx_get_data_addr(mlx.buffer.img,
			&mlx.buffer.bits_per_pixel, &mlx.buffer.line_length,
			&mlx.buffer.endian);
